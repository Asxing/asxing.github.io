...
title: 软件工程开发原则
author: HoldDie
img: https://www.holddie.com/img/20200219222041.png
top: false
cover: false
coverImg: https://www.holddie.com/img/20200219222041.png
toc: true
mathjax: true
tags:
  - 原则
  - 软件开发
  - 定律
date: 2020-02-19 22:06:03
password:
summary: 当人们谈论开发时，会聊到许多定律。
categories: 软件开发
---



![](https://www.holddie.com/img/20200219222041.png)
...
- [中文维基百科](https://zh.wikipedia.org/wiki/阿姆达尔定律)
...
![阿姆达尔定律](https://www.holddie.com/img/20200219220922.png)
...
- [布鲁克斯法则](https://github.com/nusr/hacker-laws-zh#布鲁克斯法则-brookss-law)
- [摩尔定律](https://github.com/nusr/hacker-laws-zh#摩尔定律-moores-law)

### 破窗效应 (The Broken Windows Theory)

- [英文维基百科](https://en.wikipedia.org/wiki/Broken_windows_theory)
- [中文维基百科](https://zh.wikipedia.org/wiki/破窗效应)
...
- [Technical Debt](https://github.com/nusr/hacker-laws-zh#TODO)
...
- [英文维基百科](https://en.m.wikipedia.org/wiki/Brooks's_law)
...
- [Death March](https://github.com/nusr/hacker-laws-zh#todo)
- [阅读清单：《人月神话》](https://github.com/nusr/hacker-laws-zh#阅读清单)

### 康威定律 (Conway's Law)

- [英文维基百科](https://en.wikipedia.org/wiki/Conway's_law)
- [中文维基百科](https://zh.wikipedia.org/wiki/康威定律)
...
- [The Spotify Model](https://github.com/nusr/hacker-laws-zh#spotify-模型-the-spotify-model)
...
- [英文维基百科](https://en.wikipedia.org/wiki/Dunbar's_number)
...
- [康威定律](https://github.com/nusr/hacker-laws-zh#康威定律-conways-law)
...
- [KISS 原则 (保持简单和直白)](https://github.com/nusr/hacker-laws-zh#kiss-原则-the-kiss-principle)

### 古德哈特定律 (Goodhart's Law)

- [英文维基百科](https://en.wikipedia.org/wiki/Goodhart's_law)
- [中文维基百科](https://zh.wikipedia.org/wiki/古德哈特定律)
...
- [英文维基百科](https://en.wikipedia.org/wiki/Hanlon's_razor)
- [中文维基百科](https://zh.wikipedia.org/wiki/汉隆的剃刀)
...
- [英文维基百科](https://en.wikipedia.org/wiki/Hofstadter's_law)
- [中文维基百科](https://zh.wikipedia.org/wiki/侯世达定律)
...
语出[《哥德尔、艾舍尔、巴赫：集异璧之大成》](https://github.com/nusr/hacker-laws-zh#阅读清单)。

参见：

- [阅读清单：《哥德尔、艾舍尔、巴赫：集异璧之大成》](https://github.com/nusr/hacker-laws-zh#阅读清单)

### 哈伯特定律 (Hutber's Law)

- [英文维基百科](https://en.wikipedia.org/wiki/Hutber's_law)
...
- [中文维基百科](https://zh.wikipedia.org/wiki/技术成熟度曲线)

> 我们倾向于过高估计技术在短期内的影响，并低估长期效应。
>
> *罗伊·阿马拉 (Roy Amara)*

技术成熟度曲线是[高德纳咨询公司](https://zh.wikipedia.org/wiki/高德纳咨询公司)对技术最初兴起和发展的视觉展现。一图顶千言：

![The Hype Cycle](https://www.holddie.com/img/20200219221121.png)
...
- [抽象泄漏定律](https://github.com/nusr/hacker-laws-zh#漏洞抽象定律-the-law-of-leaky-abstractions)
- [XKCD 1172](https://xkcd.com/1172/)

### 梅特卡夫定律 (Metcalfe's Law)

- [英文维基百科](https://en.wikipedia.org/wiki/Metcalfe's_law)
- [中文维基百科](https://zh.wikipedia.org/wiki/梅特卡夫定律)

> 在网络理论中，系统的价值约等于系统用户数的平方。

这个定律基于一个系统中可能的连接对数量，并且与[里德定律](https://github.com/nusr/hacker-laws-zh#里德定律-reeds-law)十分相近。奥德利兹科 (Odlyzko) 和其他人认为，里德定律和梅特卡夫定律夸大了系统本身的价值，因为它们没有考虑到网络效应中人类认知的限制。

参见:

- [里德定律](https://github.com/nusr/hacker-laws-zh#里德定律-reeds-law)
- [邓巴数字](https://github.com/nusr/hacker-laws-zh#邓巴数字-dunbars-number)

### 摩尔定律 (Moore's Law)

- [英文维基百科](https://en.wikipedia.org/wiki/Moore's_law)
- [中文维基百科](https://zh.wikipedia.org/wiki/摩尔定律)
...
- [英文维基百科](https://en.wikipedia.org/wiki/Murphy's_law)
- [中文维基百科](https://zh.wikipedia.org/wiki/摩菲定理)
...
这些定律常常用于幽默嘲弄。但是，类似于 [*Confirmation Bias*](https://github.com/nusr/hacker-laws-zh#TODO) 和 [*Selection Bias*](https://github.com/nusr/hacker-laws-zh#TODO) 的现象很容易导致人们过分强调这些定律（即在大部分情况下，一件事的成功会显得司空见惯；而失败才会引起更多的注意和讨论）。

参见:

- [Confirmation Bias](https://github.com/nusr/hacker-laws-zh#TODO)
- [Selection Bias](https://github.com/nusr/hacker-laws-zh#TODO)

### 奥卡姆剃刀 (Occam's Razor)

- [英文维基百科](https://en.wikipedia.org/wiki/Occam's_razor)
- [中文维基百科](https://zh.wikipedia.org/wiki/奥卡姆剃刀)
...
- [你不需要它原则 (YAGNI)](https://github.com/nusr/hacker-laws-zh#你不需要它原则-yagni)
- [没有银弹：软件工程的本质性与附属性工作](https://zh.wikipedia.org/wiki/没有银弹)
- [No Silver Bullet: Accidental Complexity and Essential Complexity](https://en.wikipedia.org/wiki/No_Silver_Bullet)

例子：

- [精益软件开发：消除浪费](https://zh.wikipedia.org/wiki/精益软件开发#消除浪费)
- [Lean Software Development: Eliminate Waste](https://en.wikipedia.org/wiki/Lean_software_development#Eliminate_waste)

### 帕金森定理 (Parkinson's Law)

- [英文维基百科](https://en.wikipedia.org/wiki/Parkinson's_law)
- [中文维基百科](https://zh.wikipedia.org/wiki/帕金森定理)

> 在工作能够完成的时限内，工作量会一直增加，直到所有可用时间都被填满为止。

基于官僚机构的研究背景，该定律被应用于软件开发中。该理论认为，团队在截止日期之前效率低下，然后在截止日期前赶紧完成工作，从而使实际截止日期变得随意。

将这个定理与[侯世达定律](https://github.com/nusr/hacker-laws-zh#侯世达定律-hofstadters-law)相结合，则会获得更加悲观的观点：为了在规定时间内完成工作，工作将增多，花费比预期更长的时间。

参见：

- [侯世达定律](https://github.com/nusr/hacker-laws-zh#侯世达定律-hofstadters-law)
...
- [英文维基百科](https://en.wikipedia.org/wiki/Putt's_Law_and_the_Successful_Technocrat)
...
这些结论表明，由于各种选择标准和群体组织的趋势，技术组织的工作层面将有一些技术人员，以及一些不了解复杂性和挑战的管理人员。这种现象可能是由于 [The Peter Principe](https://github.com/nusr/hacker-laws-zh#TODO) 或 [Dilbert's Law](https://github.com/nusr/hacker-laws-zh#TODO) 造成的。

但是，应该强调的是，诸如此类的定律是一种广泛的概括，可能适用于某些类型的组织，而不适用于其他组织。

参见：

- [The Peter Principe](https://github.com/nusr/hacker-laws-zh#TODO)
- [Dilbert's Law](https://github.com/nusr/hacker-laws-zh#TODO).
...
- [梅特卡夫定律 (Metcalfe's Law)](https://github.com/nusr/hacker-laws-zh#梅特卡夫定律-metcalfes-law)
- [邓巴数字](https://github.com/nusr/hacker-laws-zh#邓巴数字-dunbars-number)
...
- [隐式接口定律](https://github.com/nusr/hacker-laws-zh#隐式接口定律-hyrums-law)
...
- [中文维基百科](https://zh.wikipedia.org/wiki/帕金森瑣碎定理)
...
- [中文维基百科](https://zh.wikipedia.org/wiki/Unix哲学)
...
与 [帕金森琐碎定理](https://github.com/nusr/hacker-laws-zh#帕金森琐碎定理-the-law-of-triviality) 类似, 沃德勒定律指出，在设计语言时，与这些特征的重要性相比，花在语言结构上的时间过多。

参见：

- [帕金森琐碎定理](https://github.com/nusr/hacker-laws-zh#帕金森琐碎定理-the-law-of-triviality)
...
- [中文维基百科](https://zh.wikipedia.org/wiki/呆伯特法則)

> 公司会倾向于系统地将工作能力差的员工提升到管理层，以使他们脱离工作流程。
>
> *史考特·亚当斯 (Scott Adams)*

呆伯特原则是由史考特·亚当斯 (Dilbert 漫画连环画的创建者) 开发的一个管理概念，灵感来源于[彼得原理](https://github.com/nusr/hacker-laws-zh#彼得原理-the-peter-principle)。根据呆伯特原则，工作能力差的员工会被提升到管理层，从而限制他们所能造成的损害。亚当斯首先在 1995 年《华尔街日报》的一篇文章中解释了这一原则，随后在他 1996 年的商业书籍《呆伯特原则》中进行了扩展。

参见：

- [The Peter Principle](https://github.com/nusr/hacker-laws-zh#the-peter-principle)
- [普特定律](https://github.com/nusr/hacker-laws-zh#普特定律-putts-law)

### 帕累托法则 (The Pareto Principle or The 80/20 Rule)

- [英文维基百科](https://en.wikipedia.org/wiki/Pareto_principle)
- [中文维基百科](https://zh.wikipedia.org/wiki/帕累托法则)
...
- [中文维基百科](https://zh.wikipedia.org/wiki/彼得原理)
...
- [呆伯特法则](https://github.com/nusr/hacker-laws-zh#呆伯特法则)
- [普特定律](https://github.com/nusr/hacker-laws-zh#普特定律-putts-law)
...
- S：[单一功能原则 (The Single Responsibility Principle)](https://github.com/nusr/hacker-laws-zh#单一功能原则-the-single-responsibility-principle)
- O：[开闭原则 (The Open/Closed Principle)](https://github.com/nusr/hacker-laws-zh#开闭原则-the-openclosed-principle)
- L：[里氏替换原则 (The Liskov Substitution Principle)](https://github.com/nusr/hacker-laws-zh#里氏替换原则-the-liskov-substitution-principle)
- I：[接口隔离原则 (The Interface Segregation Principle)](https://github.com/nusr/hacker-laws-zh#接口隔离原则-the-interface-segregation-principle)
- D：[依赖反转原则 (The Dependency Inversion Principle)](https://github.com/nusr/hacker-laws-zh#依赖反转原则-the-dependency-inversion-principle)
...
- [中文维基百科](https://zh.wikipedia.org/wiki/单一功能原则)

> 每个模块或者类只应该有一项功能。

[SOLID](https://github.com/nusr/hacker-laws-zh#solid) 的第一个原则。这个原则表明模块或者类只应该做一件事。实际上，这意味着对程序功能的单个小更改，应该只需要更改一个组件。例如，更改密码验证复杂性的方式应该只需要更改程序的一部分。

理论上讲，这使代码更健壮，更容易更改。知道正在更改的组件只有一个功能，这意味着测试更改更容易。使用前面的例子，更改密码复杂性组件应该只影响与密码复杂性相关的功能。变更具有许多功能的组件可能要困难得多。

参见：

- [Object-Orientated Programming](https://github.com/nusr/hacker-laws-zh#todo)
- [SOLID](https://github.com/nusr/hacker-laws-zh#solid)

### 开闭原则 (The Open/Closed Principle)

- [英文维基百科](https://en.wikipedia.org/wiki/Open–closed_principle)
- [中文维基百科](https://zh.wikipedia.org/wiki/开闭原则)

> 实体应开放扩展并关闭修改。

[SOLID](https://github.com/nusr/hacker-laws-zh#solid) 的第二个原则。这个原则指出实体（可以是类、模块、函数等）应该能够使它们的行为易于扩展，但是它们的扩展行为不应该被修改。
...
- [中文维基百科](https://zh.wikipedia.org/wiki/里氏替换原则)

> 可以在不破坏系统的情况下，用子类型替换类型。

[SOLID](https://github.com/nusr/hacker-laws-zh#solid) 的第三个原则。该原则指出，如果组件依赖于类型，那么它应该能够使用该类型的子类型，而不会导致系统失败或者必须知道该子类型的详细信息。
...
- [中文维基百科](https://zh.wikipedia.org/wiki/接口隔离原则)

> 不应强制任何客户端依赖于它不使用的方法。

[SOLID](https://github.com/nusr/hacker-laws-zh#solid) 的第四个原则。该原则指出组件的消费者不应该依赖于它实际上不使用的组件函数。
...
该原则与面向对象编程紧密相关，其中接口，层次结构和抽象类型用于不同组件的 [minimise the coupling](https://github.com/nusr/hacker-laws-zh#todo)。 [Duck typing](https://github.com/nusr/hacker-laws-zh#todo) 是一种通过消除显式接口来强制执行该原则的方法。

参见：

- [Object-Orientated Programming](https://github.com/nusr/hacker-laws-zh#todo)
- [SOLID](https://github.com/nusr/hacker-laws-zh#solid)
- [Duck Typing](https://github.com/nusr/hacker-laws-zh#todo)
- [Decoupling](https://github.com/nusr/hacker-laws-zh#todo)

### 依赖反转原则 (The Dependency Inversion Principle)

- [英文维基百科](https://en.wikipedia.org/wiki/Dependency_inversion_principle)
- [中文维基百科](https://zh.wikipedia.org/wiki/依赖反转原则)

> 高级模块不应该依赖于低级实现。

[SOLID](https://github.com/nusr/hacker-laws-zh#solid) 的第五个原则。该原则指出，更高级别的协调组件不应该知道其依赖项的详细信息。
...
这个原则很复杂，因为它似乎可以反转系统的预期依赖性（因此得名）。实践中，这也意味着，单独的编排组件必须确保抽象类型的正确实现被使用（例如在前面的例子中，必须提供元数据读取器组件、HTTP 文件下载功能和 HTML 元标签读取器）。然后，这涉及诸如 [Inversion of Control](https://github.com/nusr/hacker-laws-zh#todo) 和 [Dependency Injection](https://github.com/nusr/hacker-laws-zh#todo) 之类的模式。

参见：

- [Object-Orientated Programming](https://github.com/nusr/hacker-laws-zh#todo)
- [SOLID](https://github.com/nusr/hacker-laws-zh#solid)
- [Inversion of Control](https://github.com/nusr/hacker-laws-zh#todo)
- [Dependency Injection](https://github.com/nusr/hacker-laws-zh#todo)

### 不要重复你自己原则 (The DRY Principle)

- [英文维基百科](https://en.wikipedia.org/wiki/Don't_repeat_yourself)
- [中文维基百科](https://zh.wikipedia.org/wiki/一次且仅一次)
...
- [中文维基百科](https://zh.wikipedia.org/wiki/KISS原则)
...
- [盖尔定律](https://github.com/nusr/hacker-laws-zh#盖尔定律-galls-law)

### 你不需要它原则 (YAGNI)

- [英文维基百科](https://en.wikipedia.org/wiki/You_aren't_gonna_need_it)

这是 ***Y**ou **A**ren't **G**onna **N**eed **I**t* 的缩写。
...
- [阅读清单《极限编程安装》](https://github.com/nusr/hacker-laws-zh#阅读清单)
...
- [寻找分布式计算的谬误（第一部分） - Vaidehi Joshi on Medium](https://medium.com/baseds/foraging-for-the-fallacies-of-distributed-computing-part-1-1b35c3b85b53)
...
- 《人月神话》[谷歌阅读地址](https://www.goodreads.com/book/show/13629.The_Mythical_Man_Month)、[豆瓣地址](https://book.douban.com/subject/26358448/) - 软件工程的经典书籍。这本书的中心主题就是[布鲁克斯法则](https://github.com/nusr/hacker-laws-zh#布鲁克斯法则-brookss-law) 。
- 《哥德尔、艾舍尔、巴赫：集异璧之大成》[谷歌阅读地址](https://www.goodreads.com/book/show/24113.G_del_Escher_Bach)、[豆瓣地址](https://book.douban.com/subject/1291204/) - 这本书很难分类。[侯世达定律](https://github.com/nusr/hacker-laws-zh#侯世达定律-hofstadters-law) 来自此书。
- 《呆伯特原则》[谷歌阅读地址](https://www.goodreads.com/book/show/85574.The_Dilbert_Principle) - 一本审视美国企业的漫画书，其作者创造了[呆伯特法则](https://github.com/nusr/hacker-laws-zh#呆伯特法则-the-dilbert-principle)。
- 《彼得原理》[谷歌阅读地址](https://www.goodreads.com/book/show/890728.The_Peter_Principle) - 一本专注于大型组织和人员管理的挑战的漫画书，也是[彼得原理](https://github.com/nusr/hacker-laws-zh#彼得原理-the-peter-principle)的来源。





本文摘抄自 https://github.com/nusr/hacker-laws-zh